...
public class IAPKey
{
    public const string PACK1 = "ff_1diamond";
    public const string PACK2 = "ff_10diamond";
    public const string PACK3 = "ff_20diamond";
    public const string PACK4 = "ff_50diamond";
}
